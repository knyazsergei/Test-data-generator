$(document).ready(function()
{
	...
	function AddTestToView(name, expression)
	{
		$('<label/>', {
			...
			title: expression
		}).append("<div class=\"row\"><input type=\"checkbox\" value=\"" + expression + "\"><div class=\"col-md-4 name\">"+ name + "</div><div class=\"col-md-8 regexpListElement\">" + excerpt(expression, 40) + "</div></div>").appendTo("#testListBox");		
	...
	$('#saveButton').on('click', function(e){
		...
		textFile += ",";
		$('#testListBox label').each(function() {
			var str = $(this).children(".row").children(".name").text();
			textFile +=  str;
			textFile += ",";
		});
